const TRANSLATIONS = {
  en: {
    ...
    "edit_feed.additional.explicit": "Explicit",
    "edit_feed.additional.block": "Block",
    "edit_feed.additional.complete": "Complete",
    "edit_feed.additional.author": "Show Author",
    "edit_feed.additional.owner": "Show Owner",
    "edit_feed.additional.owner.email": "Show owner email",
    "edit_feed.additional.owner.name": "Show owner name",
    "edit_feed.additional.new_feed_url": "Redirect to new feed url",
    "edit_feed.additional.type": "Show type",
    "edit_feed.additional.explicit.note": "Contains explicit content",
    "edit_feed.itunes.title": "Itunes specific",
    "edit_feed.itunes.keywords": "Keywords",
    "edit_feed.itunes.category": "Category",
