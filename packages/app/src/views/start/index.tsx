...
import { HalfPageBox } from "@fourviere/ui/lib/layouts/columns";
        ...
        <StartByDrag>
          <HalfPageBox>
            <Container spaceY="xl">
              <H1>
                <Trans
                  i18nKey="start:index:welcome"
                  prefix="index"
                  components={{
                    create: <H1Link onClick={createProject} />,
                    load_from_url: (
                    ...
                    podcast_index: (
                      <span
                        style={{
                          visibility: isPodcastIndexEnabled
                            ? "visible"
                            : "hidden",
                        }}
                      />
                    ),
                    load_from_podcastindex: (
